      ...
      <div class="kanban-col" data-col="${col.key}" style="flex:1;max-width:none;">
        ...
        <div class="kanban-cards" data-col="${col.key}">
          ${items.map(t => {
            ...
            return `
            <div class="kanban-card" draggable="true" data-id="${t.id}" onclick="if(!this._dragged)openTareaModal('${t.id}')" ondragstart="this._dragged=true" ondragend="setTimeout(()=>{this._dragged=false},200)" style="${esProy ? 'background:var(--primary-dark);border-color:var(--primary-dark);' : (t.recurrencia ? 'background:#f5f3ff;border-color:#ddd6fe;' : '')}">
