...
- **Repositorio de Guiones**: sección propia (separada del calendario de contenidos) para acumular guiones sueltos, vinculados o no a una pieza de contenido — pensada para cargar de una varios guiones (por ejemplo, para grabar muchos videos en una sola sesión) sin necesidad de crear cada contenido primero. Permite vincular un guion existente a un contenido, traer al repositorio el guion que ya esté escrito en un contenido existente, y vincula automáticamente un guion suelto con un contenido nuevo cuando comparten el mismo título. Los guiones se pueden archivar y se listan agrupados por mes y día.
...
- **Contenidos y pauta propios de la agencia**: la agencia (COSMART o cualquier otra que use el sistema) puede usar el mismo módulo de Contenidos, Guiones/Teleprompter y Pauta digital para su propio uso interno, aislado de los datos de sus clientes.
